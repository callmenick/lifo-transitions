(function(){
  ...
  gitFork.setAttribute( 'src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=lifo-transitions&type=fork&count=true' );
  ...
  gitWatch.setAttribute( 'src', 'http://ghbtns.com/github-btn.html?user=callmenick&repo=lifo-transitions&type=watch&count=true' );
